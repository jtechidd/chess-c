...
move_t* move_new_taking_piece(piece_id_t piece_id, vector2_t position_to, piece_id_t take_piece_id) {
    move_t* move = move_new_moving_piece(piece_id, position_to);
    move_with_taking_piece(move, take_piece_id);
}

move_t* move_new_castling(move_castling_type_t castling_type) {
    move_t* move = move_new();
...
void move_with_moving_piece(move_t* move, piece_id_t piece_id, vector2_t position_to) {
...
void move_with_taking_piece(move_t* move, piece_id_t take_piece_id) {
