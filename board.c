...
board_t* board_clone(board_t* boardsrc) {
...
void board_clear_cells(board_t* b) {
...
void board_register_pieces_new_game(board_t* board) {
    board_register_piece(board, (piece_t*)rook_new(PIECE_ID_BLACK_ROOK_QUEEN_SIDE, SIDE_BLACK, vector2_make(0, 0)));
    board_register_piece(board, (piece_t*)knight_new(PIECE_ID_BLACK_KNIGHT_QUEEN_SIDE, SIDE_BLACK, vector2_make(0, 1)));
    board_register_piece(board, (piece_t*)bishop_new(PIECE_ID_BLACK_BISHOP_QUEEN_SIDE, SIDE_BLACK, vector2_make(0, 2)));
    board_register_piece(board, (piece_t*)queen_new(PIECE_ID_BLACK_QUEEN, SIDE_BLACK, vector2_make(0, 3)));
    board_register_piece(board, (piece_t*)king_new(PIECE_ID_BLACK_KING, SIDE_BLACK, vector2_make(0, 4)));
    board_register_piece(board, (piece_t*)bishop_new(PIECE_ID_BLACK_BISHOP_KING_SIDE, SIDE_BLACK, vector2_make(0, 5)));
    board_register_piece(board, (piece_t*)knight_new(PIECE_ID_BLACK_KNIGHT_KING_SIDE, SIDE_BLACK, vector2_make(0, 6)));
    board_register_piece(board, (piece_t*)rook_new(PIECE_ID_BLACK_ROOK_KING_SIDE, SIDE_BLACK, vector2_make(0, 7)));
    for (piece_id_t j = 0; j < 8; j++) {
        board_register_piece(board, (piece_t*)pawn_new(PIECE_ID_BLACK_PAWN_1 + j, SIDE_BLACK, vector2_make(1, j)));
    }

    board_register_piece(board, (piece_t*)rook_new(PIECE_ID_WHITE_ROOK_QUEEN_SIDE, SIDE_WHITE, vector2_make(7, 0)));
    board_register_piece(board, (piece_t*)knight_new(PIECE_ID_WHITE_KNIGHT_QUEEN_SIDE, SIDE_WHITE, vector2_make(7, 1)));
    board_register_piece(board, (piece_t*)bishop_new(PIECE_ID_WHITE_BISHOP_QUEEN_SIDE, SIDE_WHITE, vector2_make(7, 2)));
    board_register_piece(board, (piece_t*)queen_new(PIECE_ID_WHITE_QUEEN, SIDE_WHITE, vector2_make(7, 3)));
    board_register_piece(board, (piece_t*)king_new(PIECE_ID_WHITE_KING, SIDE_WHITE, vector2_make(7, 4)));
    board_register_piece(board, (piece_t*)bishop_new(PIECE_ID_WHITE_BISHOP_KING_SIDE, SIDE_WHITE, vector2_make(7, 5)));
    board_register_piece(board, (piece_t*)knight_new(PIECE_ID_WHITE_KNIGHT_KING_SIDE, SIDE_WHITE, vector2_make(7, 6)));
    board_register_piece(board, (piece_t*)rook_new(PIECE_ID_WHITE_ROOK_KING_SIDE, SIDE_WHITE, vector2_make(7, 7)));
    for (piece_id_t j = 0; j < 8; j++) {
        board_register_piece(board, (piece_t*)pawn_new(PIECE_ID_WHITE_PAWN_1 + j, SIDE_WHITE, vector2_make(6, j)));
    }
}
...
uint8_t board_can_take_position(board_t* board, piece_t* piece, vector2_t position) {
...
move_array_t* board_get_moves(board_t* board, side_t side) {
    piece_id_t piece_id_start;
    piece_id_t piece_id_end;
    if (side == SIDE_WHITE) {
    ...
    for (piece_id_t pieceid = piece_id_start; pieceid <= piece_id_end; pieceid++) {
        ...
        move_array_t* positional_moves = piece->piece_get_positional_moves(piece, board);
        for (size_t i = 0; i < positional_moves->length; i++) {
            move_t* move = move_array_get_index(positional_moves, i);
...
void board_apply_move(board_t* board, move_t* move) {
    ...
    if (move->flags & MOVE_FLAGS_HAS_PROMOTION) {
        ...
        switch (move->promote_to) {
            case PIECE_TYPE_QUEEN:
                board_register_piece(board, (piece_t*)queen_new(piece_id, piece->side, move->position_to));
                break;
            case PIECE_TYPE_ROOK:
                board_register_piece(board, (piece_t*)rook_new(piece_id, piece->side, move->position_to));
                break;
            case PIECE_TYPE_BISHOP:
                board_register_piece(board, (piece_t*)bishop_new(piece_id, piece->side, move->position_to));
                break;
            case PIECE_TYPE_KNIGHT:
                board_register_piece(board, (piece_t*)knight_new(piece_id, piece->side, move->position_to));
                break;
        }
...
uint8_t board_is_position_get_attacked(board_t* board, side_t side, vector2_t position) {
