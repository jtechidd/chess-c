...
void board_register_pieces_new_game(board_t *board) {
  board_register_piece(board, (piece_t *)rook_new(PIECE_ID_BLACK_ROOK_1, SIDE_BLACK, vector2_make(0, 0)));
  board_register_piece(board, (piece_t *)knight_new(PIECE_ID_BLACK_KNIGHT_1, SIDE_BLACK, vector2_make(0, 1)));
  board_register_piece(board, (piece_t *)bishop_new(PIECE_ID_BLACK_BISHOP_1, SIDE_BLACK, vector2_make(0, 2)));
  ...
  board_register_piece(board, (piece_t *)bishop_new(PIECE_ID_BLACK_BISHOP_2, SIDE_BLACK, vector2_make(0, 5)));
  board_register_piece(board, (piece_t *)knight_new(PIECE_ID_BLACK_KNIGHT_2, SIDE_BLACK, vector2_make(0, 6)));
  board_register_piece(board, (piece_t *)rook_new(PIECE_ID_BLACK_ROOK_2, SIDE_BLACK, vector2_make(0, 7)));
  for (piece_id_t j = 0; j < 8; j++) {
    board_register_piece(board, (piece_t *)pawn_new(PIECE_ID_BLACK_PAWN_1 + j, SIDE_BLACK, vector2_make(1, j)));
  }

  board_register_piece(board, (piece_t *)rook_new(PIECE_ID_WHITE_ROOK_1, SIDE_WHITE, vector2_make(7, 0)));
  board_register_piece(board, (piece_t *)knight_new(PIECE_ID_WHITE_KNIGHT_1, SIDE_WHITE, vector2_make(7, 1)));
  board_register_piece(board, (piece_t *)bishop_new(PIECE_ID_WHITE_BISHOP_1, SIDE_WHITE, vector2_make(7, 2)));
  ...
  board_register_piece(board, (piece_t *)bishop_new(PIECE_ID_WHITE_BISHOP_2, SIDE_WHITE, vector2_make(7, 5)));
  board_register_piece(board, (piece_t *)knight_new(PIECE_ID_WHITE_KNIGHT_2, SIDE_WHITE, vector2_make(7, 6)));
  board_register_piece(board, (piece_t *)rook_new(PIECE_ID_WHITE_ROOK_2, SIDE_WHITE, vector2_make(7, 7)));
  for (piece_id_t j = 0; j < 8; j++) {
...
void board_register_piece(board_t *board, piece_t *piece) { board->pieces[piece->id] = piece; }
...
uint8_t board_has_piece_on_position(board_t *board, vector2_t position) { return board_get_piece_by_position(board, position) != NULL; }
